            ...
            for index in range(start, end):
                ...
                with inner_quantization_context:
                    if isinstance(layer, TransformerLayer):
                        ...
                        # HyperConnectionHybridLayer wraps TransformerLayer but deliberately
                        # exposes the narrower HybridStack call signature. Preserve the
                        # padding mask and token IDs needed by wrapped MoE layers while
                        # removing only the cross-attention arguments the wrapper rejects.
